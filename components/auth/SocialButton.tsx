...
export function SocialButton({
  ...
  const getURL = () => {
    // For client-side components, use window.location.origin
  ...
  const handleSignIn = async () => {
    try {
      ...
      if (error) {
        console.error(`Error signing in with ${config.name}:`, error.message)
  ...
  return (
    <LoadingButton
      ...
      loading={isLoading}
      loadingText={`Signing in with ${config.name}...`}
